...
const SeoCard2 = ({ title, description, price, button, consist, item1, item2, item3, item4, item5, item6, item7 }) => {
  let itemsToShow;

  if (title === 'Basic') {
    itemsToShow = [item1, item2, item3, item4];
  } else if (title === 'Standard') {
    itemsToShow = [item1, item2, item3, item4, item5, item6];
