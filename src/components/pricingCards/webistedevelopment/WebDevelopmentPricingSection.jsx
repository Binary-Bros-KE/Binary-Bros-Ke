  ...
  return (
    <>
      <PricingCards 
          ...
          description={"Transform your online presence with our comprehensive web development packages. From sleek personal portfolios to robust corporate websites, we offer <span>tailored solutions to meet your unique needs.</span> Our expert team ensures every website is designed for optimal performance, user experience, and scalability."}/>
    </>
  )
}
