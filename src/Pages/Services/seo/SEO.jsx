      ...
      <div className="seo-home">
        ...
        <div className={`seo-home-right ${isSticky ? 'sticky' : ''}`}>
          <div className="page-links">
            <h1>Core Services</h1>
            <a href="/websitedevelopment">Website Development<i className="fas fa-chevron-right"></i></a>
            <a href="#">Mobile Applications<i className="fas fa-chevron-right"></i></a>
            <a href="#">E-commerce Solutions<i className="fas fa-chevron-right"></i></a>
            <a href="#">Management Systems<i className="fas fa-chevron-right"></i></a>
            <a href="#">Social Media Management<i className="fas fa-chevron-right"></i></a>
            <a href="#">Google/Social Media Ads<i className="fas fa-chevron-right"></i></a>
            <a href="#">Graphic Design<i className="fas fa-chevron-right"></i></a>
            <a href="#">Cloud Infrastructure Services<i className="fas fa-chevron-right"></i></a>
            <a href="#">Data Analysis & visualization<i className="fas fa-chevron-right"></i></a>
            <a href="/quote">Get Free Quote<i className="fas fa-chevron-right"></i></a>
          </div>
          ...
          <div className="help-contacts">
            ...
            <div className="quote-button">
              <a href="#quote">Free Quote <i className="fa fa-link"></i> </a>
            </div>
          </div>
